import {
  ...
  const XcardTeams = () => {
    ...
    const features = [
      {
        ...
        description1: "Manage all team members' digital business cards from a single dashboard.",
        description2: "Easily share and collaborate on contacts and leads.",
     
      },
      {
        title: "Consistent Branding",
        description1: "Ensure all team members use consistent branding guidelines.",
        description2: "Allow teams to customize their digital business cards with their unique branding.",
      
      },
      {
        title: "Improved Efficiency",
        description1: "Save time and effort by automating the process of sharing contact information.",
    ...
    return (
      <Grid container spacing={2} padding={10} mt={10} justifyContent="center" alignItems="center">
